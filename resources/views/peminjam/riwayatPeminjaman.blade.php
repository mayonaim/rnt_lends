...
@section('content')
    ...
    <div class="container-fluid">
        <div class="scroll-horizontal">
            ...
            <div class="card-body">
                <p class="lg-4">Riwayat saat melakukan peminjaman.</p>
                <table id="table1" class="table table" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-success checkout-button"
                                    data-bs-toggle="modal">Pengembalian</button></td>
                        </tr>
                        <tr>
                            <td>2</td>
