@extends('main.main_penanggungjawab')
@section('mainpenanggungjawab')
<!-- Begin Page Content -->
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Akan ada sanksi, jika melakukan kerusakan</div>
                        </div>
                    </div>
                </div>
            </div>
