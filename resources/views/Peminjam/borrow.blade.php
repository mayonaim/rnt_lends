    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <div class="modal fade" id="ruanganModal" tabindex="-1" role="dialog" aria-labelledby="ruanganModalLabel"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="ruanganCarousel" class="carousel slide" data-ride="carousel">
                                ...
                                <a class="carousel-control-prev" href="#ruanganCarousel" role="button" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next" href="#ruanganCarousel" role="button" data-slide="next">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-default, btn-center" onclick="decrement()"
                                            style="width: 30px;">-</button>
                                    </span>
                                    <input type="text" id="quantity" class="form-control, btn-center" value="0"
                                        style="width: 30px;">
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-default, btn-center" onclick="increment()"
                                            style="width: 30px;">+</button>
                                    </span>
                                </div>
                            </div>
                ...
                <!-- Modal -->
                <div class="modal fade" id="alatModal" tabindex="-1" role="dialog" aria-labelledby="alatModalLabel"
                    aria-hidden="true">
                ...
                <div class="modal fade" id="formPengajuanModal" tabindex="-1" aria-labelledby="formPengajuanModalLabel"
                    aria-hidden="true">
